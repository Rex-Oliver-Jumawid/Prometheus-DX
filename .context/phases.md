...
`finalmodel.html` must not be treated as the production authorization mechanism.
...
Add management visibility and analytics over canonical operational data.

### Required pages and interfaces

- `/visiwork` or the final approved reporting route
